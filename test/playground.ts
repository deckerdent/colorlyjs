...
import ColorFactory, {ColorModes} from "../src/ColorFactory";
import CSSColors from "../src/util/CSSColors";

//initializing color

console.log("############## initializing randomized test ##################");
let debugMode = false;
if (debugMode) {
...
for (let i = 0; i <= 1000; i++) {
    ...
    console.log(`[iteration ${i}] mode ${modes[mode] as ColorModes}(${mode})`);
...
function getInitialColor(mode) {
    ...
    switch (mode) {
        ...
        case 1:
            ...
            initialColor = ColorFactory.createColor(modes[mode] as ColorModes, initialColor);
            break;
        case 2:
            initialColor = ColorFactory.createColor(
                modes[mode] as ColorModes,
        ...
        case 7:
            ...
            initialColor = ColorFactory.createColor(modes[mode] as ColorModes, initialColorKey);
            break;
