...
describe(".toRGBCSSString(), .toRGBACSSString(), .cssStringToRGBArray(), .cssStringToRGBAArray()", () => {
    test.each(testRGBFunctions)(
        ...
        (a: number, b: number, c: number, expected: string) => {
    ...
    test.each(testRGBFunctions)(
        ...
        (a: number, b: number, c: number, expected: any) => {
    ...
    test.each(testRGBAFunctions)(
        ...
        (a: number, b: number, c: number, d: number, expected: string) => {
    ...
    test.each(testRGBAFunctions)(
        ...
        (a: number, b: number, c: number, d: number, expected: any) => {
...
describe(".toCMYKCSSString(), .cssStringToCMYKArray()", () => {
    test.each(testCMYKFunctions)(
        ...
        (a: number, b: number, c: number, d: number, expected) => {
...
describe(".toHSLCSSString(), .cssStringToHSLArray()", () => {
    test.each(testHSLFunctions)(
        ...
        (a: number, b: number, c: number, expected) => {
